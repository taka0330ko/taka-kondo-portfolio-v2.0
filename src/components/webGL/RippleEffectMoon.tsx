...
import moon from "../../assets/images/archive/moon.webp"
...
function RippleEffectMoon() {
  ...
  useEffect(() => {
    ...
    const init = (THREE: typeof import("./three-lite")): (() => void) | null => {
      ...
      // moon image is only downloaded once; the fallback stays visible until
      // the first WebGL frame has actually been drawn.
      const fallbackImage =
    ...
    // fallback <img> keeps the moon visible until the WebGL canvas is ready
